...
ActiveRecord::Schema.define(:version => 20130402023430) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "assessment_scores_score_index"
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "batches_flags_and_course_id_and_name"
  ...
  add_index "fa_groups_subjects", ["fa_group_id", "subject_id"], :name => "fa_groups_subjects_score_index"
  ...
  add_index "student_additional_details", ["student_id", "additional_field_id"], :name => "student_additional_details_student_data_index"
  ...
  add_index "students", ["nationality_id", "immediate_contact_id", "student_category_id"], :name => "student_student_data_index"
